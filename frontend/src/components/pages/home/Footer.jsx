...
//           <div>
//             <div className="mb-3">
//               <img src={logo} alt="CyGen Logo" className="h-10 w-auto" />
//             </div>
//             <p className="mb-4">
...
const Footer = () => {
  ...
  const categories = [
    { icon: <div className="w-3 h-3 bg-blue-500 rounded-full mr-2" />, name: 'IT Infrastructure' },
  ...
  return (
    <div id="contact" className="bg-gradient-to-br from-gray-900 to-black text-white relative overflow-hidden">
      {/* Background Blobs */}
      ...
      <div className="text-center py-16 px-6 max-w-6xl mx-auto relative z-10">
        <div className="inline-block px-4 py-1 bg-blue-900/30 backdrop-blur-sm rounded-full mb-6 border border-blue-500/30">
        ...
        <div className="flex justify-center gap-6 flex-wrap">
          <button
            className="relative bg-gradient-to-r from-blue-600 to-cyan-600 font-medium px-8 py-4 rounded-xl hover:from-blue-500 hover:to-cyan-500 transition-all duration-300 group overflow-hidden"
          ...
          >
            ...
            <div className={`absolute inset-0 bg-gradient-to-r from-blue-500 to-cyan-500 opacity-0 group-hover:opacity-100 transition-opacity duration-300 ${isHovered ? 'animate-pulse' : ''}`} />
          </button>

          <button className="bg-transparent border-2 border-blue-500 px-8 py-4 rounded-xl hover:bg-blue-500/20 transition-all duration-300 group flex items-center">
            <span className="group-hover:text-cyan-300 transition-colors">Become a Consultant</span>
            <div className="ml-3 w-8 h-8 rounded-full bg-blue-500 flex items-center justify-center group-hover:bg-cyan-500 transition-colors">
              <FaPaperPlane className="text-white text-sm transform -rotate-45" />
            </div>
          </button>
        </div>
      </div>
      ...
      <footer className="pt-16 pb-12 px-6 md:px-10 relative z-10">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="flex gap-5 mb-6">
                {[FaFacebookF, FaTwitter, FaLinkedinIn, FaGithub].map((Icon, index) => (
                  <div
                    key={index}
                    className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center cursor-pointer hover:bg-blue-600 transition-all duration-300 group"
                  >
              ...
              <div className="flex items-center text-gray-400 hover:text-white transition-colors">
                <MdOutlineEmail className="mr-3 text-blue-500" />
              ...
              <form onSubmit={handleSubmit} className="mb-4">
                <div className="relative">
                  <input
                    ...
                    placeholder="Your email address"
                    required
                    className="w-full px-5 py-4 rounded-xl bg-gray-800 border border-gray-700 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                  <button
                    type="submit"
                    className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-gradient-to-r from-blue-600 to-cyan-600 p-3 rounded-xl hover:from-blue-500 hover:to-cyan-500 transition-all"
                  >
                    <FaPaperPlane className="text-white" />
                  </button>
                </div>
        ...
        <div className="fixed bottom-8 right-8 z-50">
          <div className="relative">
            <div className="absolute -top-2 -right-2 w-6 h-6 rounded-full bg-cyan-400 flex items-center justify-center text-xs font-bold animate-ping" />
            <div className="bg-gradient-to-br from-blue-600 to-cyan-600 p-4 rounded-full shadow-xl cursor-pointer hover:scale-105 transition-all duration-300 group">
