    ...
    <main>
      ...
      <div className="flex flex-col lg:flex-row sm:p-6 gap-6">
        ...
        <div
          ...
          } w-full lg:w-1/3 bg-white rounded-xl shadow p-4`}
        >
        ...
        {/* Right Panel */}
        {selectedQuery && (
          <div className="w-full lg:flex-1 border rounded-lg p-5 bg-white shadow">
            {/* Back button for mobile */}
            <button
              className="lg:hidden flex items-center gap-2 mb-4 text-primary"
            ...
            <p className="text-sm text-gray-600 my-2">
              ...
              {selectedQuery.sessionDateTime
                ? new Date(selectedQuery.sessionDateTime).toLocaleString(
                    "en-US",
                    {
                      weekday: "long",
                      month: "short",
            ...
            <div className="flex flex-col sm:flex-row gap-4 my-6">
              <button
                ...
                className="border border-gray-300 px-4 py-2 rounded text-gray-600 w-full sm:w-auto"
              >
                {rejected}
              </button>
              <button
