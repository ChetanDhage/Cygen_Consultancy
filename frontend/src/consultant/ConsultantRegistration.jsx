  ...
  <header className=" bg-white p-6 w-full flex justify-between items-center mb-2 ">
   ...
   <div className=" p-6 bg-gray-100 ">
    <div className=" mx-auto lg:p-10 p-6 bg-white rounded-lg shadow-md">
      <h1 className="text-2xl font-bold text-gray-600 mb-2">Consultant Registration</h1>
      <p className="text-gray-600 mb-6">Complete your profile to start accepting consulting sessions</p>
      
      <div className="border-t border-gray-200 pt-6 mb-6">
        <h2 className="text-xl font-semibold text-gray-600 mb-4">Verification Status</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        <div>
          ...
          <p className="text-gray-600 ml-6">John Doe</p>
        </div>
        ...
        <div>
          ...
          <p className="text-gray-600 ml-6">+1 (555) 123-4567</p>
        </div>
        ...
        <div>
          ...
          <p className="text-gray-600 ml-6">Full-time Consultant</p>
        </div>
        ...
        <div>
          ...
          <p className="text-gray-600 ml-6">john.doe@example.com</p>
        </div>
        ...
        <div>
          ...
          <p className="text-gray-600 ml-6">8 years</p>
        </div>
        ...
        <div>
          ...
          <p className="text-gray-600 ml-6">Business Strategy</p>
        </div>
      </div>

      <div className="mb-6">
        <h2 className="text-xl font-semibold text-gray-600 mb-4">Certifications</h2>
      ...
      <div className="flex justify-end space-x-4 pt-4 border-t border-gray-200">
        <button className="px-4 py-2 border border-gray-300 text-gray-500 rounded-md hover:bg-gray-50">
          Cancel
        </button>
